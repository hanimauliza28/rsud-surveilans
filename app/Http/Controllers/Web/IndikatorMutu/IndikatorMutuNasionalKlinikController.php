...
class IndikatorMutuNasionalKlinikController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $imutNasionalManajemen = IndikatorMutuNasional::where('kategori_indikator_id', 2)->with('frekuensi', 'kategori', 'tipe')->get();
        $data = [
            'date' => $dataMonth['date'],
        ...
        return view('contents.indikatorMutu.nasional.klinik.index', $data);
    ...
    public function search(Request $request)
    {
        ...
        $imut = $this->indikatorMutuNasional->searchPerKategori(2, $filterKeyword, $dataMonth['firstDay'], $dataMonth['lastDay']);
        ...
        $imut ?
            ...
            return view('contents.indikatorMutu.nasional.klinik.table', $data);
    }
