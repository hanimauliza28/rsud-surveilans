...
class Klinik extends Component
{
    ...
    public function render()
    {
        ...
        $imut = $indikatorMutuNasional->searchPerKategori(2, $filterKeyword, $dataMonth['firstDay'], $dataMonth['lastDay']);
        ...
        return view('livewire.indikator-mutu-nasional.klinik', $data);
    }
