...
class CreateIndikatorMutuNasionalTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('indikator_mutu_nasional', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('indikator_mutu_nasional');
    }
}
