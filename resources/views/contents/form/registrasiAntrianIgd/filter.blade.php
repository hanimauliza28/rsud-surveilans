<div class="d-flex" data-kt-user-table-toolbar="base">
    <!--begin::Menu-->
    <button type="button" class="btn btn-color-primary btn-active-light-primary me-3" data-kt-menu-trigger="click"
        ...
        <div class="px-7 py-5">
            ...
            <div class="mb-4">
                ...
                <div class="position-relative d-flex w-100">
                    ...
                    <select class="form-select form-select-solid w-100" name="filterPanggil" id="filterPanggil">
                        <option></option>
...
<div class="d-flex" data-kt-user-table-toolbar="base">
    <!--begin::Filter-->
    <button type="button" onclick="exportExcel()" class="btn btn-light-primary me-3">
        <!--begin::Svg Icon | path: icons/duotune/general/gen031.svg-->
        <span class="svg-icon svg-icon-2 svg-icon-primary">
