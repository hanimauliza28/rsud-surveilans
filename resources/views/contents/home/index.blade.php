            ...
            <div class="card card-flush">
                ...
                @if ($pengumuman)
                    <div class="card-body mb-1 pb-1">
                        <!--begin::Alert-->
                        <div
                            class="alert alert-dismissible bg-light-primary border border-primary d-flex flex-column flex-sm-row p-6">
                            <!--begin::Icon-->
                            ...
                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                ...
                                <!--end::Title-->
                                <!--begin::Content-->
                                <span>{{ $pengumuman->deskripsi_singkat }}</span>
                                <!--end::Content-->
                                <div class="end text-end">
                                    <a href="{{ route('pengumuman.show', $pengumuman->id) }}" target="_blank" class="btn btn-primary btn-sm end mt-5 me-1">Baca Selengkapnya</a>
                                </div>
                            </div>
                            <!--end::Wrapper-->
                        </div>
