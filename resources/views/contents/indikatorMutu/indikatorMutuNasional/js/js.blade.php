@push('extraScript')
    ...
    {{-- Reset --}}
    <script>
        $('#indikator-mutu-nasional-modal').on('hidden.bs.modal', function() {
    ...
    <script>
        const dataImutNasional = () => {
            $('#data-table').DataTable({
                ...
                responsive: true,
                ajax: {
                    url     : route('indikator-mutu-nasional.datatable'),
                    type    : 'POST',
                    data    : {
                        _token  : '{{ csrf_token() }}'
                    }
    ...
    <script>
        $('#btn-tambah').on('click',function(){
            $('#indikator-mutu-nasional-modal').modal('show');
        ...
        const edit = (id) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional.edit', id),
                type : 'GET',
                dataType : 'JSON',
        ...
        $('#btn-simpan').on('click', function(e) {
            ...
            var data = $('#form-indikator-mutu-nasional').serialize();
            var id = $('#id').val();
            var url;
            var textBtn;
            if (id === '') {
                url = route('indikator-mutu-nasional.store');
                textBtn = 'Simpan';
            } else {
                url = route('indikator-mutu-nasional.update', id);
                textBtn = 'Ubah';
            }
            ...
            $.ajax({
                ...
                success : function (data) {
                    $('#indikator-mutu-nasional-modal').modal('hide');
    ...
    <script>
        const hapus = (id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url : route('indikator-mutu-nasional.destroy', id) ,
                        type : 'POST',
                        data : {
                            _method : 'DELETE',
                            _token : '{!! csrf_token() !!}'
        ...
        const detail = (id) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional.view', id) ,
                type : 'GET',
                beforeSend : function (data) {
                    loadingModal();
                },
