<div class="modal fade" id="indikator-mutu-nasional-modal" role="dialog" aria-labelledby="Modal" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body-layer modal-body py-4 px-10">
                <form id="form-indikator-mutu-nasional" method="POST">
                    {{ csrf_field() }}
