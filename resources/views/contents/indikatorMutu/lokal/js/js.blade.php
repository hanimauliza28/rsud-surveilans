@push('extraScript')
    ...
    <script>
        const detail = (id) => {
            ...
            $.ajax({
                url : route('indikator-mutu-lokal-monitoring.view', id) ,
                type : 'GET',
    ...
    <script>
        const masukanNilai = (imutId, hari, bulan, tahun) => {
            ...
            $.ajax({
                url : route('indikator-mutu-lokal-monitoring.variabel', imutId),
                type : 'POST',
                data : {
                    _token : '{!! csrf_token() !!}',
        ...
        $('#btn-simpan-nilai').on('click', function(e) {
            ...
            var url = route('indikator-mutu-lokal-monitoring.storeNilai');
            var textBtn = 'Simpan';
