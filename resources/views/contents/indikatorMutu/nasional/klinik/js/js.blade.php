@push('extraScript')
    ...
    <script>
        const detail = (id) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional-klinik.view', id) ,
                type : 'GET',
    ...
    <script>
        const masukanNilai = (imutId, hari, bulan, tahun) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional-klinik.variabel', imutId),
                type : 'POST',
                data : {
                    _token : '{!! csrf_token() !!}',
        ...
        $('#btn-simpan-nilai').on('click', function(e) {
            ...
            var url = route('indikator-mutu-nasional-klinik.storeNilai');
            var textBtn = 'Simpan';
