...
@section('title')
    Hasil Survey Indikator Mutu Wajib
@endsection
            ...
            <div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky"
                ...
                <div class="card-header my-1 py-1">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="fw-bolder text-dark">Daftar Indikator Mutu</span>
                    </h3>
                </div>
                <div class="card-body">
                    <div
                        ...
                        @foreach ($daftarImut as $daftar)
                            <!--begin::Menu item-->
                            <a class="menu-item text-grey"
                                href="{{ route('indikator-mutu-nasional.hasil', ['id' => $daftar->id, 'tanggal' => $filterTanggal]) }}">
                                <!--begin::Trash-->
                                <span class="menu-link {{ $daftar->id == $indikatorMutuId ? 'active' : '' }}  mb-0 pb-0">
                                    ...
                                    <span class="menu-title fw-bolder">{!! $daftar->judul !!}</span>
                                </span>
                                <!--end::Trash-->
                            </a>
                            <!--end::Menu item-->
            ...
            <div class="card mb-5 pb-5">
                ...
                <div class="card-header border-0 pt-3">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-docs-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Cari Nama Pasien" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                            ...
                            <div class="input-group input-group-solid">
                                ...
                                <div class="flex-grow-1" style="width:200px">
                                    ...
                                    <input type="text" class="form-control form-control-solid" name="filterTanggal"
                                        id="filterTanggal" value="{{ $filterTanggal }}" />
                                    <!--end::Input-->
                                </div>
                            </div>
                        ...
                        <div class="d-flex align-items-center position-relative my-1 ms-4">
                            <button onclick="cariData()" type="button" class="btn btn-primary me-2" title="Cari Data">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none">
                                        <path
...
@include('contents.indikatorMutu.nasional.wajib.js.jsHasil')
