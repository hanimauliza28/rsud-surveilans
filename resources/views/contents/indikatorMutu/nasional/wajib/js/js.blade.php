@push('extraScript')
    ...
    <script>
        const detail = (id) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional-wajib.view', id) ,
                type : 'GET',
    ...
    <script>
        const masukanNilai = (imutId, hari, bulan, tahun) => {
            ...
            $.ajax({
                url : route('indikator-mutu-nasional-wajib.variabel', imutId),
                type : 'POST',
                data : {
                    _token : '{!! csrf_token() !!}',
        ...
        $('#btn-simpan-nilai').on('click', function(e) {
            ...
            var url = route('indikator-mutu-nasional-wajib.storeNilai');
            var textBtn = 'Simpan';
        ...
        const sync = (indikatorMutuId, kolomTanggal) => {
            var filterTanggal = $('#filterTanggal').val();
            $.ajax({
                url : "{{ route('indikator-mutu-nasional-wajib.sync') }}",
                type : 'POST',
