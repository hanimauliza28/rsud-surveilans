        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100">
                ...
                <input type="text" id="dataPasienNama" name="dataPasienNama"
                    class="form-control form-control-solid w-100 ps-15" placeholder="Nama Pasien" readonly />
            </div>
            <!--end::Search-->
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100 mt-2">
                ...
                <input type="text" id="dataPasienNorm" name="dataPasienNorm"
                    class="form-control form-control-solid w-100 ps-15" placeholder="No. Rekam Medis" readonly />
            </div>
            <!--end::Search-->
        </div>
        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100">
                ...
                <input type="text" id="dataPasienNoreg" name="dataPasienNoreg"
                    class="form-control form-control-solid w-100 ps-15" placeholder="No. Registrasi" readonly />
            </div>
            <!--end::Search-->
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100 mt-2">
                ...
                <input type="text" id="dataPasienBagian" name="dataPasienBagian"
                    class="form-control form-control-solid w-100 ps-15" placeholder="Poli/Ruang Periksa" readonly />
