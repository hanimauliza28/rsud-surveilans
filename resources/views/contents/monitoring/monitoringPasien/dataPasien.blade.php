    ...
    <div class="card-body row">
        <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100">
                ...
                <input type="text" id="dataPasienNama" class="form-control form-control-solid w-100 ps-15" placeholder="Nama Pasien" />
            </div>
            <!--end::Search-->
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100 mt-2">
                ...
                <input type="text" id="dataPasienNorm" class="form-control form-control-solid w-100 ps-15" placeholder="No. Rekam Medis" />
            </div>
            <!--end::Search-->
        </div>
        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100">
                ...
                <input type="text" id="dataPasienNoreg" class="form-control form-control-solid w-100 ps-15" placeholder="No. Registrasi" />
            </div>
            <!--end::Search-->
            ...
            <div class="d-flex align-items-center position-relative my-1 w-100 mt-2">
                ...
                <input type="text" id="dataPasienPoli" class="form-control form-control-solid w-100 ps-15" placeholder="Poli Periksa" />
            </div>
            <!--end::Search-->
        </div>
    </div>
