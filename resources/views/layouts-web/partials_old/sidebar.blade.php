            ...
            <div class="menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold" id="#kt_aside_menu" data-kt-menu="true">
                <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item here show py-2">
                    ...
                    <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                        ...
                        <div class="menu-item">
                            <a class="menu-link active" href="../../demo6/dist/dashboards/online-courses.html">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                    <span class="menu-link menu-center" title="Data Imut" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon me-0">
                            <i class="bi bi-file-text fs-2"></i>
                        </span>
                        <span class="menu-title">Data Imut</span>
                    </span>
                    <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('indikator-mutu-nasional-manajemen.index') }}">
                                        ...
                                        <span class="menu-title">Indikator Area Manajemen</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('indikator-mutu-nasional-klinik.index') }}">
                                        ...
                                        <span class="menu-title">Indikator Area Klinik</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('indikator-mutu-nasional-wajib.index') }}">
                                        ...
                                        <span class="menu-title">Indikator Wajib</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('indikator-mutu-nasional.index') }}">
                                        ...
                                        <span class="menu-title">Rekap IMUT</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo6/dist/account/security.html">
                                        ...
                                        <span class="menu-title">Daftar IMUT Lokal</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">Referensi (DEV)</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo6/dist/account/overview.html">
                                        ...
                                        <span class="menu-title">Kategori Indikator</span>
                                    </a>
                                </div>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo6/dist/account/security.html">
                                        ...
                                        <span class="menu-title">Tipe Indikator</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="../../demo6/dist/account/settings.html">
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                    <span class="menu-link menu-center" title="Form Builder" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon me-0">
                            <i class="bi bi-file-text fs-2"></i>
                        </span>
                        <span class="menu-title text-center">Form Builder</span>
                    </span>
                    <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <div class="menu-item">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('referensi-element.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Referensi Element</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('referensi-element-attribute.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"><f/span>
                                        </span>
                                        <span class="menu-title">Referensi Attribute</span>
                                    </a>
                                </div>
                                <div class="menu-item">
