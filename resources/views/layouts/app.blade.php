								...
								<div class="row g-5 g-xl-10">
									...
									<div class="col-xl-4 mb-xl-10">
										...
										<div class="card card-flush h-xl-100">
											<!--begin::Heading-->
											<div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('{{ asset('assets/media/svg/shapes/top-green.png') }}')">
												<!--begin::Title-->
												<h3 class="card-title align-items-start flex-column text-white pt-15">
													...
													<div class="fs-4 text-white">
														...
														<span class="position-relative d-inline-block">
															<a href="../../demo8/dist/pages/user-profile/projects.html" class="link-white opacity-75-hover fw-bolder d-block mb-1">4 tasks</a>
															<!--begin::Separator-->
											...
											<div class="card-body d-flex ps-xl-15">
												...
												<div class="m-0">
													...
													<span class="position-relative d-inline-block text-danger">
														<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-danger opacity-75-hover">2300 bonus</a>
														<!--begin::Separator-->
													...
													<div class="mb-3">
														...
														<a href="../../demo8/dist/apps/support-center/overview.html" class="btn btn-color-white bg-body bg-opacity-15 bg-hover-opacity-25 fw-bold">How to</a>
													</div>
													<!--begin::Action-->
												</div>
												<!--begin::Action-->
											...
											<div class="card-body pt-6">
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														...
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">UI/UX Design</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">QA Analysis</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Web Development</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Marketing</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Philosophy</a>
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center flex-row-fluid flex-wrap">
														<!--begin:Author-->
														<div class="flex-grow-1 me-2">
															<a href="../../demo8/dist/pages/user-profile/overview.html" class="text-gray-800 text-hover-primary fs-6 fw-bolder">Mathematics</a>
															<span class="text-muted fw-bold d-block fs-7">24+ Courses</span>
														</div>
														<!--end:Author-->
														<!--begin::Actions-->
								...
								<div class="current" data-kt-stepper-element="content">
									...
									<div class="w-100">
										...
										<div class="fv-row mb-10">
											...
											<!--end::Label-->
											<!--begin::Image input-->
											<div class="image-input image-input-empty image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('assets/media/svg/files/blank-image.svg') }})">
