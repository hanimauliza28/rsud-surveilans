    ...
    <div class="card">
        @if ($dataPelayanan != '')
                ...
                <form id="waktu-tunggu-rawat-jalan-form">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-12 col-form-label fw-bold fs-6">
                            ...
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                title="Waktu Pasien Hadir di Rumah Sakit"></i>
                        </label>
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-12 col-form-label fw-bold fs-6">
                            ...
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                title="Waktu Pasien Mendapatkan Pelayanan Dokter"></i>
                        </label>
                        <div class="col-sm-12 col-md-12">
                    ...
                    <div class="row mb-3">
                        <label class="col-lg-12 col-form-label fw-bold fs-6">
                            <span class="required">Waktu Tunggu Rawat Jalan (Detik)</span>
                        </label>
                        <div class="col-sm-12 col-md-12">
                            <input type="text" name="waktuTunggu" id="waktuTunggu"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="Waktu Tanggap Pelayanan Gawat Darurat"
                                value="{{ $detailHasilSurvey ? $detailHasilSurvey['waktuTunggu'] : $dataPelayanan->WAKTU_TUNGGU }}" />
                            <div class="form-text">Waktu Tunggu Rawat Jalan Dihitung Sejak Pasien Kontak dengan Petugas
                                Pendaftaran Sampai Mendapatkan Pelayanan Dokter</div>
                        </div>
                    </div>
            ...
            <div class="card-footer text-end mt-1 pt-4">
                <button id="btn-simpan" class="btn btn-primary" onclick="simpanWTRJ()">
        ...
        @else
            <div class="card-body">
                <div class="alert alert-danger border border-danger fw-bold text-center">
                    Pelayanan Pasien Belum Selesai, Waktu Tunggu Belum Dapat di Hitung
                </div>
            </div>
        @endif
    </div>
