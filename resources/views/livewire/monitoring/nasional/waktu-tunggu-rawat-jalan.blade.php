        ...
        <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <input type="text" name="waktuTunggu" id="waktuTunggu"
                            ...
                            value="{{ $detailHasilSurvey ? $detailHasilSurvey['waktuTunggu'] : $dataPelayanan['waktuTunggu'] }}" />
            ...
            <div class="d-flex align-items-center bg-light-warning rounded p-5">
                ...
                <div class="flex-grow-1 me-2">
                    ...
                    <span
                        class="text-muted fw-bold d-block">{{ $detailHasilSurvey ? $detailHasilSurvey['waktuTunggu'] : $dataPelayanan['waktuTunggu'] }}
                        Detik / Pasien</span>
                </div>
                <!--end::Title-->
                <!--begin::Lable-->
